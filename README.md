...
1. It will look for an input file named "Input.txt" in the resources folder. If it does not exist, it will create one for you.
    ...
    - Obviously, if you wish to see how the program compresses a specific text, you'll have to provide it yourself. All you would need to do in such case is to rename your text file to "Input.txt" and replace it for [the already existing file with such name](src/main/resources/Input.txt) in the resources folder.
